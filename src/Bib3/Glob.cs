...
namespace Bib3
{
	public static class Glob
	{
		...
		public static long? Max(long? o0, long? o1)
		{
			return Glob.Max((IEnumerable<long?>)new long?[2]
			{
		o0,
		o1
			});
		...
		public static long? Min(long? o0, long? o1)
		{
			return Glob.Min((IEnumerable<long?>)new long?[2]
			{
		o0,
		o1
			});
		...
		public static float? Max(float? o0, float? o1)
		{
			return o0.HasValue ? (o1.HasValue ? new float?(Math.Max(o0.Value, o1.Value)) : o0) : (o1.HasValue ? o1 : new float?());
		}

		public static float? Min(float? o0, float? o1)
		{
			return o0.HasValue ? (o1.HasValue ? new float?(Math.Min(o0.Value, o1.Value)) : o0) : (o1.HasValue ? o1 : new float?());
		}

		public static double? Max(double? o0, double? o1)
		{
			return o0.HasValue ? (o1.HasValue ? new double?(Math.Max(o0.Value, o1.Value)) : o0) : (o1.HasValue ? o1 : new double?());
		}

		public static double? Min(double? o0, double? o1)
		{
			return o0.HasValue ? (o1.HasValue ? new double?(Math.Min(o0.Value, o1.Value)) : o0) : (o1.HasValue ? o1 : new double?());
		}
		...
		public static Decimal StopwatchZaitMikroSictDecimal()
		{
			return (Decimal)Stopwatch.GetTimestamp() * 1000000M / (Decimal)Stopwatch.Frequency;
		}

		public static long StopwatchZaitMikroSictInt()
		{
			return Stopwatch.GetTimestamp() * 100000L / Stopwatch.Frequency * 10L;
		}

		public static long StopwatchZaitMiliSictInt()
		{
			return Stopwatch.GetTimestamp() * 1000L / Stopwatch.Frequency;
		}

		public static DateTime SictDateTimeVonStopwatchZaitMikro(long stopwatchZaitMikro)
		{
			return Glob.SictDateTimeVonStopwatchZaitMikro((Decimal)stopwatchZaitMikro);
		}

		public static DateTime SictDateTimeVonStopwatchZaitMikro(Decimal stopwatchZaitMikro)
		{
			return DateTime.Now - TimeSpan.FromSeconds((double)(((Decimal)Glob.StopwatchZaitMikroSictInt() - stopwatchZaitMikro) * 0.000001M));
		}

		public static DateTime SictDateTimeVonStopwatchZaitMili(Decimal stopwatchZaitMili)
		{
			return Glob.SictDateTimeVonStopwatchZaitMikro(stopwatchZaitMili * 1000M);
		}

		public static Decimal StopwatchZaitVonDateTimeMikroSictDecimal(DateTime zaitpunktSictDateTime)
		{
			return Glob.StopwatchZaitMikroSictDecimal() - (Decimal)(DateTime.Now - zaitpunktSictDateTime).TotalSeconds * 1000000M;
		}

		public static long StopwatchZaitVonDateTimeMikroSictInt(DateTime zaitpunktSictDateTime)
		{
			return (long)Glob.StopwatchZaitVonDateTimeMikroSictDecimal(zaitpunktSictDateTime);
		}

		public static XObject[] SictwaiseIPAddress(object abbildObject, out IPAddress abbildIPAddress)
		{
			return Glob.SictwaiseIPAddress(abbildObject, out abbildIPAddress, out Exception _);
		}
		...
		public static XObject[] SictwaiseInt32(object sictObjectAbbild, out int? sictInt32Abbild)
		{
			return Glob.SictwaiseInt32(sictObjectAbbild, out sictInt32Abbild, out Exception _);
		}
		...
		public static string TypeFullNameSictString(object objekt)
		{
			return objekt == null ? "null" : objekt.GetType().FullName;
		}

		public static double SictwaiseSekundeZaal(this DateTime zaitpunkt)
		{
			return (zaitpunkt - Glob.ZaitpunktNul).TotalSeconds;
		}

		public static long SictwaiseMikrosekundeZaal(this DateTime zaitpunkt)
		{
			return (long)((zaitpunkt - Glob.ZaitpunktNul).TotalSeconds * 1000000.0);
		}
		...
		public static string SictwaiseMikrosekundeString(this DateTime zaitpunkt)
		{
			return zaitpunkt.SictwaiseMikrosekundeZaal().ToString();
		}
		...
		public static T[] ArrayAusListeListeGeflact<T>(IEnumerable<IEnumerable<T>> listeListe)
		{
			return Glob.ArrayAusListeFeldGeflact<T>(listeListe.Select<IEnumerable<T>, T[]>((Func<IEnumerable<T>, T[]>)(liste => liste.ToArray<T>())));
		}
		...
		public static XElement SictwaiseXElement(Exception ausnaame)
		{
			return new XElement((XName)"Ausnaame", (object)Glob.SictwaiseXml(ausnaame));
		}
		...
		private static string EscapeAnfüürungszaicen(string @string)
		{
		...
		public static DateTime SictDateTimeVonMikrosekunde(long mikrosekunde)
		{
			return Glob.ZaitpunktNul + TimeSpan.FromSeconds((double)mikrosekunde * 1E-06);
		}

		public static DateTime SictDateTimeVonSekunde(long sekunde)
		{
			return Glob.SictDateTimeVonMikrosekunde((long)((double)sekunde * 1000000.0));
		}
		...
		public static void ScraibeInhaltNaacDataiPfaad(string dataiPfaad, byte[] dataiInhaltSol)
		{
			Glob.ScraibeInhaltNaacDataiPfaad(dataiPfaad, dataiInhaltSol, out bool _, out Exception _);
		}
		...
		public static void LaadeInhaltAusDataiPfaad(string dataiPfaad, out byte[] dataiInhalt)
		{
			Glob.LaadeInhaltAusDataiPfaad(dataiPfaad, out dataiInhalt, out byte[] _);
		}
	...
	public class SictPropagiireListeRepräsentatioonProfile
	{
		public int EntferntAnzaal;
		public int KonstruiirtAnzaal;
	}
}
