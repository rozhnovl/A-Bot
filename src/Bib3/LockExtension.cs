...
namespace Bib3.Synchronization
{
	public static class LockExtension
	{
		...
		public static void IfLockIsAvailableEnter(this object lockRef, Action action)
		{
			lockRef.WhenLockIsAvailableEnter(0, action);
		}
		...
		public static void InvokeIfNotLocked(this object lockRef, Action action)
		{
			lockRef.IfLockIsAvailableEnter(action);
		}
		...
		public static void InvokeIfNotLocked(this Action action, object lockRef)
		{
			lockRef.InvokeIfNotLocked(action);
		}
