...
{
	public struct RectInt(long min0, long min1, long max0, long max1)
	{
		public long Min0 = min0;
		public long Min1 = min1;
		public long Max0 = max0;
		public long Max1 = max1;

		public static RectInt Empty => new RectInt(0L, 0L, 0L, 0L);

		public static RectInt EmptyMin
		{
			get => new RectInt(long.MinValue, long.MinValue, long.MinValue, long.MinValue);
		}
		...
		public static RectInt FromMinPointAndMaxPoint(Vektor2DInt minPoint, Vektor2DInt maxPoint)
		{
			return new RectInt(minPoint.A, minPoint.B, maxPoint.A, maxPoint.B);
		}

		public static RectInt FromCenterAndSize(Vektor2DInt center, Vektor2DInt size)
		{
			return RectInt.FromMinPointAndMaxPoint(center - size / 2L, center + (size + new Vektor2DInt(1L, 1L)) / 2L);
		}
		/*
		public static RectInt operator -(RectInt minuend, Vektor2DInt subtrahend)
		{
			return minuend.Offset(-subtrahend);
		}

		public static RectInt operator +(RectInt sumand0, Vektor2DInt sumand1)
		{
			return sumand0.Offset(sumand1);
		}*/

		public static RectInt operator *(RectInt faktor0, long faktor1)
		{
			return new RectInt(faktor0.Min0 * faktor1, faktor0.Min1 * faktor1, faktor0.Max0 * faktor1, faktor0.Max1 * faktor1);
		}

		public static bool operator ==(RectInt o0, RectInt o1)
		{
			return o0.Min0 == o1.Min0 && o0.Min1 == o1.Min1 && o0.Max0 == o1.Max0 && o0.Max1 == o1.Max1;
		}
		...
		{
			return (this.Min0 + this.Min1 + this.Max0 + this.Max1).GetHashCode();
		}

		public static bool operator !=(RectInt vektor0, RectInt vektor1) => !(vektor0 == vektor1);

		public static string ComponentToString(long? komponente)
		{
			return Vektor2DInt.ComponentToString(komponente);
		}

		public override string ToString()
		{
			return "Min0 = " + RectInt.ComponentToString(new long?(this.Min0)) + ", Min1 = " + RectInt.ComponentToString(new long?(this.Min1)) + ", Max0 = " + RectInt.ComponentToString(new long?(this.Max0)) + ", Max1 = " + RectInt.ComponentToString(new long?(this.Max1));
		}

		public Vektor2DInt? Center()
		{
			return new Vektor2DInt((this.Min0 + this.Max0) / 2L, (this.Min1 + this.Max1) / 2L);
		}

		public int Area()
		{
			return (int)((this.Max0 - this.Min0) * (this.Max1 - this.Min1));
		}
	}

	public struct Vektor2DInt(long a, long b)
	{
		public long A = a;
		public long B = b;
		...
		public static Vektor2DInt operator -(Vektor2DInt minuend, Vektor2DInt subtrahend)
		{
			return new Vektor2DInt(minuend.A - subtrahend.A, minuend.B - subtrahend.B);
		}

		public static Vektor2DInt operator -(Vektor2DInt subtrahend)
		{
			return new Vektor2DInt(0L, 0L) - subtrahend;
		}

		public static Vektor2DInt operator +(Vektor2DInt vektor0, Vektor2DInt vektor1)
		{
			return new Vektor2DInt(vektor0.A + vektor1.A, vektor0.B + vektor1.B);
		}

		public static Vektor2DInt operator /(Vektor2DInt dividend, long divisor)
		{
			return new Vektor2DInt(dividend.A / divisor, dividend.B / divisor);
		}

		public static Vektor2DInt operator *(Vektor2DInt vektor0, long faktor)
		{
			return new Vektor2DInt(vektor0.A * faktor, vektor0.B * faktor);
		}

		public static Vektor2DInt operator *(long faktor, Vektor2DInt vektor0)
		{
			return new Vektor2DInt(vektor0.A * faktor, vektor0.B * faktor);
		}

		public static bool operator ==(Vektor2DInt vektor0, Vektor2DInt vektor1)
		{
		...
		public static string ComponentToString(long? component)
		{
			return !component.HasValue ? (string)null : Vektor2DInt.ComponentToString(component.Value);
		}

		public static string ComponentToString(long component)
		{
			return component == 0L ? "0" : component.ToString("### ### ### ### ### ### ### ### ###").Trim();
		}
		...
		public override string ToString()
		{
			return "A = " + Vektor2DInt.ComponentToString(this.A) + ", B = " + Vektor2DInt.ComponentToString(this.B);
		}
	...
	public static class Extension
	{
		...
		{
			return enumerable == null ? (IEnumerable<T>)null : enumerable.Where<T>((Func<T, bool>)(element => !object.Equals((object)default(T), (object)element)));
		}
		...
		public static double? TryParseDouble(this string text, NumberStyles numberStyle = NumberStyles.Float)
		{
			return text.TryParseDouble(Glob.NumberFormat, numberStyle);
		}
		...
		public static int? TryParseInt(this string zuParsende)
		{
			return zuParsende.TryParseInt(NumberStyles.Integer);
		}
		...
		public static long? TryParseInt64(this string zuParsende, NumberStyles numberStyle = NumberStyles.Integer)
		{
			return zuParsende.TryParseInt64(NumberFormatInfo.CurrentInfo, numberStyle);
		}
		...
		{
			return enumerable == null ? (IEnumerable<T>)null : enumerable.Reverse<T>();
		}

		public static string EnsureEndsWith(this string @string, string end)
		{
			return @string != null && @string.EndsWith(end) ? @string : @string + end;
		}

		public static string PathToFilesysChild(this string directoryPath, string child)
		{
			return directoryPath == null ? (string)null : directoryPath.EnsureEndsWith(Path.DirectorySeparatorChar.ToString()) + child;
		}

		public static bool? AllHaveValue<T>(this IEnumerable<T?> enumerable) where T : struct
		{
			return enumerable == null ? new bool?() : new bool?(enumerable.All<T?>((Func<T?, bool>)(element => element.HasValue)));
		}
		...
		{
			return seq == null || !seq.GetEnumerator().MoveNext();
		}
		...
		public static T? CastToNullable<T>(this object @ref) where T : struct
		{
			return @ref is T obj ? new T?(obj) : new T?();
		}
		...
		public static Decimal ZaitMikroSictDecimal(this Stopwatch stopwatch)
		{
			return (Decimal)stopwatch.ElapsedTicks * 1000000M / (Decimal)Stopwatch.Frequency;
		}

		public static long ZaitMikroSictInt(this Stopwatch stopwatch)
		{
			return (long)stopwatch.ZaitMikroSictDecimal();
		}
		...
		public static void Enqueue<T>(this Queue<T> queue, IEnumerable<T> sequence)
		{
			queue.EnqueueSeq<T>(sequence);
		}
		...
		public static IEnumerable<T> DequeueEnum<T>(this Queue<T> queue)
		{
			return queue.DequeueEnumerator<T>();
		}
		/*
		...
		*/
		...
		public static string AssemblyShortNameVonAssemblyName(this string assemblyName)
		{
			if (assemblyName == null)
				return (string)null;
			Match match = Extension.AssemblyShortNameRegex.Match(assemblyName);
			return !match.Success ? assemblyName : match.Groups[1].Value;
		}

		public static T NullIfEmpty<T>(this T seq) where T : IEnumerable
		{
			return seq.IsNullOrEmpty() ? default(T) : seq;
		}
		...
		public static bool SequenceEqualPerReferenceEqual(this IEnumerable seq0, IEnumerable seq1)
		{
			return seq0.SequenceEqual(seq1, new Func<object, object, bool>(object.ReferenceEquals));
		}

		public static bool SequenceEqualPerObjectEquals(this IEnumerable seq0, IEnumerable seq1)
		{
			return seq0.SequenceEqual(seq1, new Func<object, object, bool>(object.Equals));
		}
		...
		public static IEnumerable<T?> CastToNullable<T>(this IEnumerable<T> source) where T : struct
		{
			return source == null ? (IEnumerable<T?>)null : source.Select<T, T?>((Func<T, T?>)(element => new T?(element)));
		}

		public static IEnumerable<T> EmptyIfNull<T>(this IEnumerable<T> source)
		{
			return source == null ? (IEnumerable<T>)new T[0] : source;
		}

		/*
		public static WertZuZaitpunktStruct<T>? Max<T>(this IEnumerable<WertZuZaitpunktStruct<T>> source)
		{
			return new WertZuZaitpunktStruct<T>?(source.OrderByDescending<WertZuZaitpunktStruct<T>, long>((Func<WertZuZaitpunktStruct<T>, long>)(t => t.Zait)).FirstOrDefault<WertZuZaitpunktStruct<T>>());
		}
		...
		public static IDictionary<KeyT, ValueT> ToDictionary<KeyT, ValueT>(
		  this IEnumerable<KeyValuePair<KeyT, ValueT>> source)
		{
			return source == null ? (IDictionary<KeyT, ValueT>)null : (IDictionary<KeyT, ValueT>)source.ToDictionary<KeyValuePair<KeyT, ValueT>, KeyT, ValueT>((Func<KeyValuePair<KeyT, ValueT>, KeyT>)(t => t.Key), (Func<KeyValuePair<KeyT, ValueT>, ValueT>)(t => t.Value));
		}

		public static IDictionary<KeyT, ValueT[]> ToDictionary<KeyT, ValueT>(
		  this IEnumerable<IGrouping<KeyT, ValueT>> source)
		{
			return source == null ? (IDictionary<KeyT, ValueT[]>)null : source.Select<IGrouping<KeyT, ValueT>, KeyValuePair<KeyT, ValueT[]>>((Func<IGrouping<KeyT, ValueT>, KeyValuePair<KeyT, ValueT[]>>)(group => new KeyValuePair<KeyT, ValueT[]>(group.Key, group.ToArray<ValueT>()))).ToDictionary<KeyT, ValueT[]>();
		}
		...
		public static int PropagiireListObjectEquals(this IEnumerable source, IList dest)
		{
			return source.PropagiireList(dest, (Func<object, object, bool>)((a, b) => object.Equals(a, b)));
		}
		...
		public static Regex AlsRegex(this string regexPattern, RegexOptions regexOptions)
		{
			return regexPattern != null ? new Regex(regexPattern, regexOptions) : (Regex)null;
		}
		...
		public static IEnumerable<T> TakeWhileNotDefault<T>(this IEnumerable<T> seq)
		{
			return seq == null ? (IEnumerable<T>)null : seq.TakeWhile<T>((Func<T, bool>)(element => !object.Equals((object)element, (object)default(T))));
		}
		...
		public static int? FirstIndexOrNullPerEquals<T>(this IEnumerable<T> liste, T valueId)
		{
			return liste.FirstIndexOrNull<T>((Func<T, bool>)(kandidaat => object.Equals((object)kandidaat, (object)(T)valueId)));
		}
		...
		public static T DefaultIfNull<T>(this T? orig) where T : struct
		{
			return !orig.HasValue ? default(T) : orig.Value;
		}
